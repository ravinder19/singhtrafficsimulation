...
Map.prototype.publishData = function() {
	...
	//console.log("current heading: " + this.currentEdge.heading);
...
//var sf_map = new Map("sanfrancisco", "San Francisco", "maps/san_francisco-clean.osm");
//var vegas_map = new Map("vegas", "Las Vegas", "maps/vegas-clean.osm");
...
Vehicle.prototype.setNextEdge = function() {
	...
	while (!edge) {
		try { 
			...
			//console.log("checking edge: " + this.currentEdge.a + "   " + n.edges[idx].b);
			if (this.currentEdge.a == n.edges[idx].b) {
				if (n.edges.length == 1) {
